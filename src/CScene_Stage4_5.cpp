...
CScene_Stage4_5::CScene_Stage4_5()
{
	Background = NULL;
	Hero = NULL;
...
void CScene_Stage4_5::Open()
{
	...
	AddResourceWithKey(IMAGE_STAGE4_5_BACKGROUND);

	Background = new CObject_Bg_Stage4_5(IMAGE_STAGE4_5_BACKGROUND,	0, 0, MapWidth, 768, TYPE_BACKGRAPH);
	Hero->MoveTo(200, 403);
...
CObject* CScene_Stage4_5::SendHero() {
	return Hero;
}

void CScene_Stage4_5::Update()
{
