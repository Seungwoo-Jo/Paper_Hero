...
CScene_Stage4_3::CScene_Stage4_3()
{
	Background = NULL;
	Hero = NULL;
...
void CScene_Stage4_3::Open()
{
	...
	AddResourceWithKey(IMAGE_STAGE4_3_BACKGROUND);
	AddResourceWithKey(IMAGE_ENEMY_STAGE4_LAMP);
	AddResourceWithKey(IMAGE_ENEMY_STAGE4_LASER);

	Background = new CObject_Bg_Stage4_3(IMAGE_STAGE4_3_BACKGROUND,	0, 0, MapWidth, 768, TYPE_BACKGRAPH);
	Hero->MoveTo(200, 403);
	Object[0] = new CObject_Lamp(IMAGE_ENEMY_STAGE4_LAMP, 4000, 250, 300, 350, TYPE_ENEMY);
...
void CScene_Stage4_3::Close()
{
	DelResourceWithKey(IMAGE_STAGE4_3_BACKGROUND);
...
CObject* CScene_Stage4_3::SendHero() {
	return Hero;
}

void CScene_Stage4_3::Update()
{
